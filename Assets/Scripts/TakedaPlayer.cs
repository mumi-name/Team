...
public class TakedaPlayer : MonoBehaviour
{
    ...
    public static TakedaPlayer instance;
    ...
    {
        var obj=Physics2D.Linecast(transform.position, transform.position - (transform.up * 3.0f));
        if (obj.collider != null && obj.collider.CompareTag("Floor"))
        {
            jumpFlag = false;
        }
    }
